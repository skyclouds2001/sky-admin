  ...
  <el-scrollbar wrap-class="wrap" view-class="view">
    <el-menu router :default-active="currentPath" :collapse="isMenuCollapse" :class="['page-sidebar', isMenuCollapse ? 'w-16' : 'w-[18rem]', 'min-h-screen', 'pb-10']">
      ...
      <el-sub-menu index="/3d">
        ...
        <el-menu-item index="/3d/material">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.material') }}</span>
        </el-menu-item>
        <el-menu-item index="/3d/camera">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.camera') }}</span>
        </el-menu-item>
        ...
        <el-menu-item index="/3d/toon-geometry">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.toon-geometry') }}</span>
        </el-menu-item>
        <el-menu-item index="/3d/fantastic-material">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.fantastic-material') }}</span>
        </el-menu-item>
        ...
        <el-menu-item index="/3d/rect-area">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.rect-area') }}</span>
        </el-menu-item>
        <el-menu-item index="/3d/angel-statue">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.angel-statue') }}</span>
        </el-menu-item>
        <el-menu-item index="/3d/physical-modal">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.physical-modal') }}</span>
        </el-menu-item>
        <el-menu-item index="/3d/logarithmic-depth-buffer">
          <el-icon><Box /></el-icon>
          <span>{{ i18n.t('router.3d.logarithmic-depth-buffer') }}</span>
        </el-menu-item>
