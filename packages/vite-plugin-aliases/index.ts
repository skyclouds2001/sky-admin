...
const generateAlias = (alias: AliasOptions, { enable = true, root = process.cwd(), dir = 'src', prefix = '@', log = true, logPath = path.resolve(process.cwd(), 'logs'), logFile = 'vite-plugin-auto-aliases.log' }: PluginConfig): AliasOptions => {
  try {
